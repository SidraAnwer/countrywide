    ...
    <div class="container-fluid">
      <div class="row px-5 mt-5">
        ...
        <div class="col-lg-6 col-md-6 col-sm-8 col-8 text-right">
          <span class="logintp1">Already Have account? &nbsp <a class="logintp2" href="">Login</a></span>
        </div>
      </div>
      ...
      <div class="row mt-5">
        ...
        <div class="offset-lg-4 col-lg-4 offset-md-4 col-md-4 col-sm-12 text-center  mt-5">
            <input id="name" type="text" class="matinplogin" name="name" placeholder="Name">
        </div>
        <div class="offset-lg-4 col-lg-4 offset-md-4 col-md-4 col-sm-12 text-center  mt-3">
            <input id="email" type="email" name="email" class="matinplogin" placeholder="Email">
        </div>
        <div class="offset-lg-4 col-lg-4 offset-md-4 col-md-4 col-sm-12 mt-3 text-center">
            <input id="password" type="password" name="password" class="matinplogin" placeholder="Password">
        </div>
        <div class="offset-lg-4 col-lg-4 offset-md-4 col-md-4 col-sm-12 mt-3 text-center">
            <input id="password-confirm" type="password" name="password_confirmation" class="matinplogin" placeholder="Confirm Password">
        </div>
        <div class="offset-lg-4 col-lg-4 offset-md-4 col-md-4 col-sm-12 mt-3 text-center">
            <button type="submit" class="btn logginmainbtn1">Sign Up</button>
        </div>
      </div>
      </form>
    </div>
