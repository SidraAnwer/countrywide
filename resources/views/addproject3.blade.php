          ...
          <form method="POST" action="{{url('store-project')}}" enctype="multipart/form-data">
            @csrf
              ...
              <div class="col-lg-12 col-md-12 col-sm-6 tableresp" style="margin-top:-10px;">
                <table class="table">
                  <tbody >
                    <tr class="pltabtr" id="storyRow">
                      <div class="row mx-1">
                        <div class="col-lg-12 col-md-12 col-sm-12"  style="background-color: white;padding: 20px;">
                          <div class="row">
                            
                        <div class="col-lg-10 col-md-10 col-sm-10 col-10">
                          <span class="head1new ml-3">1st Story</span>
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-2 ">
                          <i class="fa fa-caret-down pt-2" style="font-size: 25px;color:#000;"></i>
                        </div>
                          </div>
                        </div>
                      </div>
                    </tr>
                    <tr class="pltabtr " id="appRow">
                  <div id="accordion" style="margin-top: 5px;">
                    <div class="card">
                        ...
                        <div class="mb-0">
                          <div class="row">
                            <div class="col-lg-2 col-md-4 col-sm-5 col-5">
                              <p class="accoptq pt-2 ml-5">A1</p>
                            </div>
                            <div class="col-lg-5 col-md-8 col-sm-7 col-7" style="margin-left:-20px;">
                              <p class="accoptq pt-2">Master Baths</p>
                            </div>
                            <div class="col-lg-2 col-md-4 col-sm-4 col-4">
                              
                            </div>
                            <div class="col-lg-2 col-md-4 col-sm-6 col-6" style="margin-left:-60px;">
                              <button type="button" class="btn accbtn23">Add Area</button>
                            </div>
                            <div class="col-lg-1 col-md-4 col-sm-4 col-4" style="margin-left:-30px;">
                              <button type="button" class="btn btn-link" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                              <i class="fa fa-caret-down" style="font-size: 18px;color:#000;"></i>
                              </button>
                      ...
                      <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordion" style="background-color: #F7F7F7;">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-2 col-md-4 col-sm-6 col-6"></div>
                                <div class="col-lg-2 col-lg-2 col-md-4 col-sm-6 col-6"></div>
                                <div class="col-lg-2 col-lg-2 col-md-4 col-sm-6 col-6">
                                    <select style="width: 150px;height: 30px;margin-top:8px;font-size:12px;" name="" class="accbtn111" id="">
                                    <option value="">completed</option>
                                  </select>
                                </div>
                                <div class="col-lg-2 col-lg-2 col-md-4 col-sm-6 col-6">
                          <button type="button" class="btn accbtn23 mr-4" data-toggle="modal" data-target="#exampleModal2">Upload Media</button>
                          
                                </div>
                                
                                <div class="col-lg-2 col-lg-2 col-md-4 col-sm-6 col-6">
                          <button type="button" class="btn accbtn23" data-toggle="modal" data-target="#exampleModalvc">View Media</button>
                          
                                </div>
                                
                                <div class="col-lg-2 col-lg-2 col-md-4 col-sm-6 col-6">
                                    <a href="{{url('leaktest')}}"><button class="btn accbtn23a">Test Report</button></a>
                                </div>
                    ...
                    <div class="card"  style="margin-top:5px;">
                        ...
                        <div class="mb-0">
                          <div class="row">
                            <div class="col-lg-2 col-md-2 col-sm-4 col-4">
                              <p class="accoptq pt-2 ml-5">A2</p>
                            </div>
                            <div class="col-lg-2 col-md-2 col-sm-8 col-8">
                              <p class="accoptq pt-2">Pool</p>
                            </div>
                            <div class="col-lg-2 col-md-2 col-sm-7 col-7">
                              <select style="width: 150px;height: 30px;margin-top:8px;font-size:12px;" name="status" class="accbtn111" id="">
                                 <option value="1">completed</option>
                                 <option value="0">Inprocess</option>
                              </select>
                            </div>
                            <div class="col-lg-2 col-md-2 col-sm-5 col-5">
                              <button type="button" class="btn accbtn23" data-toggle="modal" data-target="#exampleModal">Add Media</button>
                            </div>
                            <div class="col-lg-2 col-md-2 col-sm-10 col-10 ml-3">
                              <button type="button" class="btn accbtn23" data-toggle="modal" data-target="#exampleModalvc">View Media</button>
                            </div>
                            <div class="col-lg-1 col-md-2 col-sm-2 col-2" style="margin-left:-20px;">
                      ...
                      <div id="collapsetwo" class="collapse " aria-labelledby="headingtwo" data-parent="#accordion" style="background-color: #F7F7F7;">
                       <div class="card-body">
                            <div class="row">
                                <div class="col-lg-2 col-md-4 col-sm-6 col-6"></div>
                                <div class="col-lg-2 col-lg-2 col-md-4 col-sm-6 col-6">
                                     <select style="width: 150px;height: 30px;margin-top:8px;font-size:12px;" name="" class="mr-4" id="">
                            ...
                            <option value="">completed</option>
                                ...
                                <div class="col-lg-2 col-lg-2 col-md-4 col-sm-6 col-6">
                          <button class="btn accbtn23" data-toggle="modal" data-target="#exampleModalvc">View Media</button>
                          
                                </div>
                                
                                <div class="col-lg-2 col-lg-2 col-md-4 col-sm-6 col-6">
                          <button class="btn accbtn23a">Test Report</button>
                                </div>
              ...
              <div class="row mt-3 ml-5">
                <div class="col-lg-12">
                  <button type="button"  class="btn accbtn23 " data-toggle="modal" data-target=".add-appartment" >+ Add Apartment</button>
                  <button type="button" class="btn accbtn23" data-toggle="modal" data-target=".add-area" >+ Add Area</button>
                </div >
              </div>
             ...
             <!--End Add Area Model -->
              ...
              <div class="row my-3 mx-1">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-10 col-10 text-right">
                          <select name="" class="accbtn11" id="">
                            <option value="">Story</option>
                          </select>
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-12 col-12 ">
                          <i class="fa fa-plus pt-2" style="font-size: 30px;color:#000;"></i>
                        </div>
                          </div>
                        </div>
              </div>
  ...
  <div class="modal-dialog modal-xl" role="document" >
    ...
    <span class="drop-zone__prompt">
        <img src="{{asset('assets/images/draw.PNG')}}">
                  ...
                  <span style="color:black;font-size:12px;">Supports:JPG,PNG,PDF</span>
    </span>
