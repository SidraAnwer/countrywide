...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{asset('assets/js/jquery.signature.js')}}">
    ...
    <div class="s-layout">
      ...
      <div class="s-layout__sidebar">
        ...
        <li class="text-uppercase">
           ...
           <a class="s-sidebar__nav-link addrema active1" >
              Employ Details <i class="fa fa-angle-down downdown"></i>
           </a>
   
           <ul>
                <li class="clk"><a href="{{url('add-employee')}}" class="s-sidebar__nav-link"><i class="fa fas-plus-circle" style="margin-right:20px;"></i>Add Users</a></li>
                <li class="clk"><a href="{{url('add-employee-list')}}" class="s-sidebar__nav-link"><i class="fa fas-plus-circle" style="margin-right:20px;"></i>Users</a></li>
                <li class="clk"><a href="{{url('timesheet')}}" class="s-sidebar__nav-link"><i class="fa fas-plus-circle" style="margin-right:20px;"></i>Timesheets</a></li>
                <li class="clk"><a href="{{url('complete-timesheet')}}" class="s-sidebar__nav-link"><i class="fa fas-plus-circle" style="margin-right:20px;"></i>Completed Timesheets</a></li>
            </ul>
        </li>
        <li class='sub-menu1 addremli' >
           ...
           <a class="s-sidebar__nav-link addrema" id="aaaa2">
...
$(document).on("change", ".ot", function() {
    ...
    console.log(sum);
         ...
         <script>
            $(document).ready(function(){
  $('.addremul .addremli .addrema').click(function(){
    $('.addremul .addrema.').removeClass("active1");
