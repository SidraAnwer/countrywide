    ...
    <div class="s-layout">
      ...
      <div class="s-layout__sidebar">
        ...
        <li class="text-uppercase">
           <a class="s-sidebar__nav-link active1" href="{{url('home')}}">
              dashboard
           </a>
        </li>
        <li class="text-uppercase">
...
//     var totalRT = parseInt(rt1) + parseInt(rt2) + parseInt(rt3) + parseInt(rt4)+ parseInt(rt5)+ parseInt(rt6);
//     var totalOT = parseInt(ot1) + ot2 + ot3 + ot4+ ot5+ ot6;
//     $("#totalrt").html(totalRT);
//     console.log(a);
//     $("#totalot").html(totalOT);
