...
@section('content')
      <!-- Content -->
          ...
          <form method="POST" action="{{url('store-project')}}" id="projectForm" enctype="multipart/form-data">
            @csrf
              <div class="row mt-4">
              ...
              <div class="modal-dialog modal-xl" role="document" >
                ...
                <span class="drop-zone__prompt">
                    <img src="{{asset('assets/images/draw.PNG')}}">
                          <div style="color:black;font-size:20px;">Drop your file here or <span style="color:#F73C16 !important;">Browse</span></div>
                                  <span style="color:black;font-size:14px !important;">Supports:JPG,PNG,PDF</span>
                </span>
          ...
          <div class="text-right">
           ...
           <button type="button"  class="newaddfrmbtn2 mr-2">Upload</button>
          </div>
      </div>
...
@push('scripts')
  ...
  $("#appartBtn").click(function(){
       event.preventDefault();
         ...
         var markup ='<tr><td><div class="card"><div class="card-header bg-white" id="headingOne"><div class="mb-0"><div class="row"><div class="col-lg-2 col-md-4 col-sm-5 col-5"><p class="accoptq pt-2 ml-5">A1</p></div><div class="col-lg-5 col-md-8 col-sm-7 col-7" style="margin-left:-20px;"><p class="accoptq pt-2">'+appartmentName+'</p></div><div class="col-lg-2 col-md-4 col-sm-4 col-4"></div><div class="col-lg-2 col-md-4 col-sm-6 col-6" style="margin-left:-60px;"></div><div class="col-lg-1 col-md-4 col-sm-4 col-4" style="margin-left:-30px;"></div></div></div></div><div id="panel" style="background-color: #F7F7F7;"><div class="card-body"><div class="row"><div class="col-lg-2 col-md-4 col-sm-6 col-6"></div><div class="col-lg-2 col-lg-2 col-md-4 col-sm-6 col-6"></div><div class="col-lg-2 col-lg-2 col-md-4 col-sm-6 col-6"><select style="width: 150px;height: 30px;margin-top:8px;font-size:12px;" name="" class="slec1c mr-4" id=""><option value="">completed</option></select></div><div class="col-lg-2 col-lg-2 col-md-4 col-sm-6 col-6"><button type="button" class="btn accbtn23 mr-4" data-toggle="modal" data-target="#exampleModal2">Upload Media</button></div><div class="col-lg-2 col-lg-2 col-md-4 col-sm-6 col-6"><button type="button" class="btn accbtn23" data-toggle="modal" data-target="#exampleModalvc">View Media</button></div><div class="col-lg-2 col-lg-2 col-md-4 col-sm-6 col-6"><button type="button" class="btn accbtn23a">Test Report</button></div></div></div></div></div></td></tr>'; 
         $("table tbody").append(markup);
     
  });
  $("#areaBtn").click(function(){
         var area_name = $("#area_name").val();
         var markup ='<tr><td><div class="card"><div class="card-header bg-white" id="headingOne"><div class="mb-0"><div class="row"><div class="col-lg-2 col-md-4 col-sm-5 col-5"><p class="accoptq pt-2 ml-5">A1</p></div><div class="col-lg-2 col-md-8 col-sm-7 col-7" style="margin-left:-20px;"><p class="accoptq pt-2">'+area_name+'</p></div><div class="col-lg-2 col-lg-2 col-md-4 col-sm-6 col-6"><select style="width: 150px;height: 30px;margin-top:8px;font-size:12px;" name="" class="slec1c mr-4" id=""><option value="">not get start</option><option value="">inprocess</option><option value="">completed</option></select></div><div class="col-lg-2 col-lg-2 col-md-4 col-sm-6 col-6"><button type="button" class="btn accbtn23 mr-4" data-toggle="modal" data-target="#exampleModal2">Upload Media</button></div><div class="col-lg-2 col-lg-2 col-md-4 col-sm-6 col-6"><button type="button" class="btn accbtn23" data-toggle="modal" data-target="#exampleModalvc">View Media</button></div><div class="col-lg-2 col-lg-2 col-md-4 col-sm-6 col-6"><a href="https://countrywide.pelicula-entertainment.com/leaktest"><button class="btn accbtn23a">Test Report</button></a></div></div></div></div><div id="panel" style="background-color: #F7F7F7;"></td></tr>'; 
         $("table tbody").append(markup);
          $('#add-area').modal('hide');
